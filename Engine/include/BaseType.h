...
#define CLS_KLBUISHADER			(53| CLS_KLBUSERTASK)
#define CLS_KLBUITEXTINPUT		(54| CLS_KLBUSERTASK)

// export objects
#define CLS_KLBBINARRAY			(55| CLS_KLBENGINECLASS)
#define CLS_KLBLUADB			(56| CLS_KLBENGINECLASS)
#define CLS_KLBDATASET			(57| CLS_KLBENGINECLASS)
#define CLS_KLBNODEVIRTUALDOC	(58 | CLS_KLBENGINECLASS | CLS_KLBUICORECLASS)
#define CLS_KLBFONTOBJ			(59| CLS_KLBENGINECLASS)
#define CLS_KLBSOUNDOBJ			(60| CLS_KLBENGINECLASS)
#define CLS_KLBMATRIXOBJ		(61| CLS_KLBENGINECLASS)
#define CLS_KLBVECTOROBJ		(62| CLS_KLBENGINECLASS)

#define CLS_KLBUNITTASK			(63| CLS_KLBUSERTASK)
#define CLS_KLBMAPGROUP			(64| CLS_KLBUSERTASK)

#define CLS_KLBSTORESERVICE		(65| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBNETAPI			(66| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBPAUSECTRL		(67| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBLIFECTRL			(68| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBAIDRIVERTASK		(69| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBWORDLTASK		(70| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBUIWEBVIEW		(71| CLS_KLBUSERTASK)

#define CLS_KLBAPPPROP			(72| CLS_KLBENGINECLASS)

#define CLS_KLBACTIVITYINDICATORNODE    (73| CLS_KLBENGINECLASS)    // CKLBActivityIndicatorNode
#define CLS_KLBUIACTIVITYINDICATOR      (74| CLS_KLBUSERTASK)    // CKLBUIActivityIndicator

#define CLS_KLBUIVARIABLEITEM			(75| CLS_KLBUSERTASK)
#define CLS_KLBUICLIP					(76| CLS_KLBUSERTASK)
#define CLS_KLBAPPUPDATE				(77| CLS_KLBENGINECLASS)
#define CLS_KLBASYNCLOADER				(78| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBGCTASK					(79| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBAPPUPDATEZIP				(80| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBASYNCFILECOPY			(81| CLS_KLBUSERTASK | CLS_NONVISUALTASK)

#define CLS_KLBUIBUTTON			(82| CLS_KLBUSERTASK)
#define CLS_KLBPACKERCTRL		(83| CLS_KLBENGINECLASS)
